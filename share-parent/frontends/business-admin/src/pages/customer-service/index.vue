    ...
    <el-tabs v-model="activeTab" class="service-tabs">
      ...
      <el-tab-pane label="AI 配置" name="ai-config">
        <section class="panel config-panel">
          <div class="panel-title"><h3>AI 智能客服引擎</h3><span>配置后台大模型接入服务</span></div>
          <el-form :model="aiConfig" label-width="110px" class="config-form">
            <el-row :gutter="20">
              <el-col :span="12"><el-form-item label="API 地址"><el-input v-model="aiConfig.baseUrl" placeholder="https://api.example.com" /></el-form-item></el-col>
              ...
              <el-col :span="12"><el-form-item label="模型"><el-input v-model="aiConfig.model" placeholder="请输入模型标识（留空使用默认）" /></el-form-item></el-col>
...
const aiConfig = reactive({ baseUrl: '', endpointPath: '/v1/chat/completions', model: '', apiKey: '', enabled: 0, timeoutMs: 30000, maxRetries: 1, systemPrompt: '', apiKeyConfigured: false })
...
.customer-service-page { min-height: calc(100vh - 86px); padding: 24px 4px 40px; color: #0f172a; background: #f8fafc; }.page-title { display: flex; align-items: center; justify-content: space-between; margin-bottom: 22px; }.page-title h2 { margin: 0 0 7px; color: #0f172a; font-size: 22px; font-weight: 700; }.page-title p { margin: 0; color: #64748b; font-size: 13px; }.page-title :deep(.el-tag) { display: flex; align-items: center; gap: 5px; }
.stat-grid { display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px; margin-bottom: 22px; }.stat-card { position: relative; padding: 20px 22px; border-radius: 8px; background: #ffffff; border: 1px solid #e2e8f0; color: #0f172a; box-shadow: 0 1px 3px rgba(0,0,0,.03); }.stat-card.blue strong { color: #2563eb; }.stat-card.green strong { color: #16a34a; }.stat-card.orange strong { color: #ea580c; }.stat-card.purple strong { color: #4f46e5; }.stat-label { display: block; margin-bottom: 8px; font-size: 13px; color: #64748b; font-weight: 500; }.stat-card strong { display: block; font-size: 26px; font-weight: 700; color: #0f172a; }.stat-card strong em { margin-left: 2px; font-size: 14px; font-style: normal; color: #64748b; }.stat-card small { display: block; margin-top: 6px; font-size: 12px; color: #94a3b8; }
.service-tabs :deep(.el-tabs__header) { margin-bottom: 18px; }.panel { padding: 20px; background: #fff; border-radius: 8px; border: 1px solid #e2e8f0; box-shadow: 0 1px 3px rgba(0,0,0,.03); }.analysis-grid { display: grid; grid-template-columns: 1.25fr 1fr; gap: 16px; }.panel-title { display: flex; align-items: baseline; justify-content: space-between; margin-bottom: 20px; }.panel-title h3 { margin: 0; font-size: 15px; font-weight: 600; color: #0f172a; }.panel-title span { color: #94a3b8; font-size: 12px; }.trend-chart { display: flex; align-items: flex-end; justify-content: space-around; height: 210px; padding: 12px 20px 0; border-bottom: 1px solid #f1f5f9; }.trend-item { display: flex; flex: 1; flex-direction: column; align-items: center; height: 100%; justify-content: flex-end; }.bars { display: flex; align-items: flex-end; gap: 5px; height: 170px; }.bar { position: relative; display: block; width: 18px; min-height: 10px; border-radius: 4px 4px 0 0; }.bar b { position: absolute; top: -18px; left: 50%; color: #64748b; font-size: 11px; font-weight: 500; transform: translateX(-50%); }.bar.total { background: #93c5fd; }.bar.resolved { background: #16a34a; }.trend-item > span { margin-top: 10px; color: #64748b; font-size: 12px; }.legend { display: flex; gap: 18px; margin-top: 14px; color: #64748b; font-size: 12px; }.legend span { display: flex; align-items: center; gap: 5px; }.dot { width: 8px; height: 8px; border-radius: 50%; }.blue-dot { background: #93c5fd; }.green-dot { background: #16a34a; }.question-row { display: flex; align-items: center; gap: 10px; padding: 12px 0; border-bottom: 1px solid #f1f5f9; }.question-row:last-child { border-bottom: 0; }.rank { display: inline-flex; align-items: center; justify-content: center; width: 22px; height: 22px; color: #64748b; font-size: 12px; font-weight: 600; background: #e2e8f0; border-radius: 6px; }.question-row:nth-child(3) .rank { background: #e2e8f0; color: #64748b; }.question-text { flex: 1; overflow: hidden; color: #334155; font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }.quick-metrics { display: grid; grid-template-columns: repeat(4,1fr); gap: 1px; margin-top: 16px; padding: 0; overflow: hidden; }.quick-metrics div { padding: 18px 24px; border-right: 1px solid #f1f5f9; }.quick-metrics div:last-child { border-right: 0; }.quick-metrics span { display: block; color: #64748b; font-size: 12px; }.quick-metrics strong { display: block; margin-top: 8px; color: #0f172a; font-size: 22px; font-weight: 700; }
