...
<template>
  <div class="orderCards">
    <img :src="data.coverUrl || data.courseCoverUrl || data.cover || defaultCover" alt="" @error="handleImgError($event, data)" @click="() => $router.push({path: '/details/index', query:{id: data.courseId}})">
    <div class="info">
